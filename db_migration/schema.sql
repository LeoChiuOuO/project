...
CREATE TABLE IF NOT EXISTS `reports` (
  ...
  `report_id` varchar(30) NOT NULL COMMENT '檢驗報告序號',
  `medical_order` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '醫令',
  `consent_form_state` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '同意書簽核狀態',
  `specimen_dely_state` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '檢體傳送狀態',
  `send_email_state` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '發信狀態',
  `product_name` varchar(30) NOT NULL COMMENT '檢驗產品名稱',
  `tracking_status` varchar(20) NOT NULL COMMENT '追蹤狀態',
  `notification_status` varchar(20) NOT NULL COMMENT '通知狀態',
  `partition_id` int(11) NOT NULL COMMENT '公司',
  `department_id` int(11) NOT NULL COMMENT '單位',
  `group_id` int(11) DEFAULT NULL COMMENT '組',
  `submission_date` datetime NOT NULL COMMENT '送檢日期',
  ...
  `cost` int(11) NOT NULL COMMENT '費用',
  `return_date` datetime NOT NULL COMMENT '回診日期',
  `sending_physician_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '送檢醫師',
  `remark` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '附註',
  `report_date` datetime NOT NULL COMMENT '報告日期',
  `report_results` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '報告結果',
  `create_id` int(11) NOT NULL COMMENT '建立者編號',
  `modify_id` int(11) NOT NULL COMMENT '修改人員',
  `specimen_number` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '檢體編號',
  `specimen_type` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '檢體類別',
  `testing_date` datetime NOT NULL COMMENT '採檢日期',
  `inspection_progress` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '檢驗進度',
  `assessment_status` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '評估狀態',
  `weeks_of_pregnancy` int(11) NOT NULL COMMENT '懷孕週數',
  `due_date` datetime NOT NULL COMMENT '預產期',
  `report_due_date` datetime DEFAULT NULL COMMENT '報告截止日期',
  `inspection_institution` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '送檢院所',
  `inspection_institution_phone` int(11) NOT NULL COMMENT '送檢院所電話',
  `responsible_business_person` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '負責業務',
  `responsible_business_phone` int(11) NOT NULL COMMENT '負責業務電話',
  `responsible_business_email` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '負責業務Email',
  `business_manager` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '業務主管',
  `business_manager_phone` int(11) NOT NULL COMMENT '業務主管電話',
  `business_manager_email` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '業務主管Email',
  `abnormal_report_delivery_method` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '異常報告寄送方式',
  `abnormal_report_notification_method` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '異常報告通知方式',
  `inspection_group` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '檢驗組別',
  `notification_circumstances` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '通知情形',
  `prenatal_testing_project_tracking_time` datetime NOT NULL COMMENT '產前檢測項目追蹤時間',
  `confirm_specimen_submission_time` datetime NOT NULL COMMENT 'Confirm檢體進件時間',
  `confirm_specimen_type` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT 'Confirm檢體類別',
  `confirm_the_test_report_results` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT 'Confirm檢體報告結果',
  `tracking_time` datetime NOT NULL COMMENT '追蹤時間',
  `tracking` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '追蹤情形',
  `tracking_results` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_uca1400_ai_ci NOT NULL COMMENT '追蹤結果',
  `tracking_the_followup_status_of_NIPS_cases` datetime NOT NULL COMMENT '追蹤NIPS個案後續狀況時間',
